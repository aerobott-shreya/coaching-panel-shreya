...
function ContentQA({ access }) {
  ...
  const redirectTo = () => {
    navigate("/dashboard/content/qa/createTest");
  };

  const goToCreateAssignment = (vals) => {
    navigate(`/dashboard/content/qa/addQuestion/${vals.id}`, { state: vals });
  };
    ...
    <div>
      <div className={styles.Container}>
        ...
        <div className={styles.assign_data}>
          <div className={styles.head}>Worksheets</div>
        ...
        {datas == 1 && (
          <div>
            ...
            <AsignTable testId={assignList[0]?.id}/>
