...
import { updateSudentReducer } from './updateStudentReducer';
...
function StudentProfileView() {
    ...
    var { id } = useParams();
    const [state, dispatch] = useReducer(updateSudentReducer, initialState);
    ...
    console.log(contact_Data, 'user_Data')
    useEffect(() => {
        getData();
    }, [id]);
            ...
            <div style={{ padding: '20px' }}>
                ...
                <form onSubmit={(e) => onSubmit(e, "user_Data")} >
                        ...
                        <div className={`${styles.personalField} ${styles.marginData}`} style={{ marginTop: '-10px' }}>
                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <MobileDatePicker
                                    ...
                                    onChange={(date) => handleDate(date, "user_Data", "1", "drawer")}
                    ...
                    <div className={styles.personalData}>
                        ...
                        <div className={styles.personalField} style={{ marginTop: '-20px' }}>
                    ...
                    <div className={styles.personalData}>
                        <div className={`${styles.personalField} ${styles.marginData}`} style={{ margin: 0 }}>
                            <FormControl sx={{ m: 1, minWidth: 240 }}>
    ...
    const addressData = () => {
        return (
            <div style={{ padding: '20px' }}>
                <div className={` ${styles.fontNormal}`} style={{ marginBottom: '20px', fontWeight: 'bold' }}>Address Details</div>
    ...
    const educationData = () => {
        return (
            <div style={{ padding: '20px' }}>
                <div className={` ${styles.fontNormal}`} style={{ marginBottom: '20px', fontWeight: 'bold' }}>Educational Details</div>
                <form onSubmit={(e) => onSubmit(e, "education_Data")} >
                    ...
                    <div className={styles.personalData}>
                        ...
                        <div className={`${styles.personalField} ${styles.marginData}`}>
                            <FormControl sx={{ m: 1, minWidth: 160 }}>
                                <InputLabel className={` ${styles.fontNormal} font-regular`} id="demo-simple-select-label">Section</InputLabel>
                                <Select
                                    labelId="demo-simple-select-label"
                                    id="demo-simple-select"
                                    ...
                                    onChange={(e) => handleChanges(e, "education_Data", "drawer")}
                                >
                                    {sectionList && sectionList.map((v, i) => (<MenuItem value={v.id}>{v.title}</MenuItem>))}
                                </Select>
                            </FormControl>
                        </div>
                    </div>
        ...
        <div>
            ...
            <div className={`${styles.containProfile} ${styles.PersonalDetails}`}>
                <div className={styles.personalData}>
                    ...
                    {<p className={`${styles.edits}  ${styles.fontNormal}`} onClick={() => { handleDrawerOpen(USER_DETAILS); getUserData(userState, "User_state") }} style={{ cursor: 'pointer', display: 'flex', alignItems: 'center' }}>Edit <EditOutlinedIcon style={{ marginLeft: '10px', fontSize: '18px' }} /></p>}
                </div>
                <div className={styles.personal}>
                    <div>
                        <p className={`${styles.fontBold}  ${styles.fontNormal}`}>DOB</p>
                        <p className={`${styles.userGrey}  ${styles.fontNormal}`}>{userState?.dob}</p>
                    </div>
                    <div>
                        <p className={`${styles.fontBold}  ${styles.fontNormal}`}>Place of Birth</p>
                        <p className={`${styles.userGrey}  ${styles.fontNormal}`}>{userState?.place_of_birth}</p>
                    </div>
                    <div>
                        <p className={`${styles.fontBold}   ${styles.fontNormal}`}>Age</p>
                        <p className={`${styles.userGrey}    ${styles.fontNormal}`}>{userState?.age}</p>
                    </div>
                    <div>
            ...
            <div className={`${styles.containProfile} ${styles.PersonalDetails}`}>
                <div className={styles.personalData}>
                    ...
                    {<p className={`${styles.edits} ${styles.fontNormal}`} onClick={() => { handleDrawerOpen(USER_ADDRESS); getUserData(userState, "user_contact") }} style={{ cursor: 'pointer', display: 'flex', alignItems: 'center' }}>Edit <EditOutlinedIcon style={{ marginLeft: '10px', fontSize: '18px' }} /></p>}
                </div>
            ...
            <div className={`${styles.containProfile} ${styles.PersonalDetails}`}>
                <div className={styles.personalData}>
                    ...
                    {<p className={`${styles.edits} ${styles.fontNormal}`} onClick={() => { handleDrawerOpen(USER_EDUCATION); getUserData(userState, "education_data") }} style={{ cursor: 'pointer', display: 'flex', alignItems: 'center' }}>Edit <EditOutlinedIcon style={{ marginLeft: '10px', fontSize: '18px' }} /></p>}
                </div>
                <div className={`${styles.personal} ${styles.personalWrap}`}>
                    <div className={styles.personalBox}>
                    ...
                    <div className={styles.personalBox}>
                        <p className={`${styles.fontNormal}`}>Grade</p>
                        <p className={`${styles.userGrey}  ${styles.fontNormal} font-regular`}>{userState?.grade?.title}</p>
                    </div>
                    <div className={styles.personalBox}>
                        <p className={`${styles.fontNormal}`}>Class</p>
                        <p className={`${styles.userGrey}  ${styles.fontNormal} font-regular`}>{userState?.class_of_student?.title}</p>
                    </div>
                    <div className={styles.personalBox}>
