...
function ContentCreateTest() {
    ...
    const getChapters = () => {
        ...
        api_token
            .get(`content/v1/chapter_wise_books/?grade=${content_selection.grade}&course=${content_selection.course}`)
            .then((res) => {
    ...
    const submitData = () => {
        ...
        if (!checkEmpy) {
            ...
            api_token
                .post(`content/test_configuration/`, finalData)
                .then((res) => {
...
export default ContentCreateTest